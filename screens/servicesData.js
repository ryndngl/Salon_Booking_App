...
export const services = [
  ...
  styles: [
    ...
    },
    {
      ...
      name: 'Cellophane',
      price: 500,
      description: "A semi-permanent gloss that boosts shine and color vibrancy.",
    ...
    },
    {
      ...
      name: 'Cystiene',
      price: 1500,
      description: "A formaldehyde-free straightening treatment for smooth, silky hair.",
    ...
    },
    {
      ...
      name: 'Hair Botox',
      price: 1000,
      description: "Restores damaged hair fibers for a healthier, youthful look.",
    ...
    },
    {
      ...
      name: 'Hair Spa',
      price: 300,
      description: "A relaxing treatment that nourishes and revitalizes hair.",
    ...
    },
    {
      ...
      name: 'Keratin',
      price: 500,
      description: "Infuses hair with keratin for smoothness and frizz control.",
  ...
  styles: [
    {
      ...
      price: 2000,
      description: "Straightens hair while restoring strength and smoothness with botox treatment.",
    ...
    },
    {
      ...
      price: 1500,
      description: "Combines rebonding with Brazilian treatment for sleek, frizz-free hair.",
    ...
    },
    {
      ...
      price: 1300,
      description: "Smooth, straight hair with an added glossy cellophane finish.",
    ...
    },
    {
      ...
      price: 2500,
      description: "Straightens and colors your hair for a vibrant, polished look.",
    ...
    },
    {
      ...
      price: 1000,
      description: "Straightens hair while infusing keratin for lasting smoothness.",
...

  {
    ...
    styles: [
      ...
      },
      {
        ...
        name: 'Removing Gel',
        price: 150,
        description: "Gentle and safe removal of gel polish without damaging nails.",
      ...
      },
      {
        ...
        name: 'Soft Gel',
        price: 800,
        description: "Flexible and lightweight nail extensions for a natural feel",
